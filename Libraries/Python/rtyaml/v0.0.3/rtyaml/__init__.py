...
# Add a representer for python objects that auto-coverts them into dicts.
def our_object_representer(dumper, value):
    return ordered_dict_serializer(dumper, value.__dict__)
    
Dumper.add_multi_representer(object, our_object_representer)
