    ...
    def _retry_using_http_Negotiate_auth(self, response, scheme, args):
        ...
        if self._host is None:
            ...
            try:
                ...
                print('Skipping canonicalization of name %s due to error: %s', self._host, e)
        ...
        try:
            ...
            print('Sending Initial Context Token - error={} authenticated={}'.format(error, clientauth.authenticated))
        except pywintypes.error as e:
            print('Error calling {}: {}'.format(e[1], e[2]), exc_info=e)
            return response
            ...
            if response2.status_code == 200:
                ...
                if final is not None:
                    try:
                        ...
                        error, auth = clientauth.authorize(sec_buffer)
                        print('Kerberos Authentication succeeded - error={} authenticated={}'.format(error, clientauth.authenticated))
                    except TypeError:
                        pass
        ...
        sec_buffer.append(tokenbuf)
        print('Got Challenge Token (NTLM)')
